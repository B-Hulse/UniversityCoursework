...
void  BVH::RenderBone( float x0, float y0, float z0, float x1, float y1, float z1, float bRadius )
{
	...
	GLdouble  dir_x = (GLdouble)x1 - (GLdouble)x0;
	GLdouble  dir_y = (GLdouble)y1 - (GLdouble)y0;
	GLdouble  dir_z = (GLdouble)z1 - (GLdouble)z0;
	...
	glColor3f(1., 0., 0.);
	gluSphere(quad_obj, radius * 2, slices, stack);
