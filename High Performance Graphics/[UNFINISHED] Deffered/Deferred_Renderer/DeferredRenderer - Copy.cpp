...
void DeferredRenderer::createDescriptorPool() {
    ...
    VkDescriptorPoolSize poolSizes[] =
    {
        ...
        { VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, static_cast<uint32_t>(swapChainImages.size()) + 1000 },
        { VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE, 1000 },
        { VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1000 },
        { VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER, 1000 },
        { VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER, 1000 },
        { VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, static_cast<uint32_t>(swapChainImages.size()) +1000 },
...
void DeferredRenderer::updateUniformBuffer(uint32_t currentImage) {

    // Uniform buffer struct that we will pass to the shader
    UniformBufferObject ubo{};

    // Specify the model transformation matrix as a rotation by 90 degrees, around the z axis, for each second since the program has elapsed
    ...
    ubo.view = glm::lookAt(glm::vec3(0.f, -100.f, 50.f), glm::vec3(0.0f, 0.0f, 25.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    ...
    // Flip the y axis in the projection matrix
    // This is to fix a difference between openGL and vulkan where the Y coordinate of clip space is inverted
    ubo.proj[1][1] *= -1;
    ...
    ubo.l_ambient = glm::vec4(1.f, 1.f, 1.f, 1.f);
    ubo.l_diffuse = glm::vec4(1.f, 1.f, 1.f, 1.f);
    ubo.l_specular = glm::vec4(1.f, 1.f, 1.f, 1.f);
