...
public:
	...
	// Projection Matrix
	std::stack<glm::mat4> pMatrixStack;

	std::stack<glm::mat4>* currMatrixStack;
	...
	float matAmbient[4] = { .2,.2,.2,1. };
	float matDiffuse[4] = { .8,.8,.8,1. };
	float matSpecular[4] = { 0.,0.,0.,1. };
	float matEmission[4] = { 0.,0.,0.,1. };
