...
RenderController::RenderController
    ...
    QObject::connect(   renderWindow->shadowsOnBox,                 SIGNAL(stateChanged(int)),
                        this,                                       SLOT(depthTestCheckChanged(int)));

    // signal for check box for Phong shading
    QObject::connect(   renderWindow->impulseReflectionBox,              SIGNAL(stateChanged(int)),
                        this,                                       SLOT(phongShadingCheckChanged(int)));

    // signal for check box for axes
    QObject::connect(   renderWindow->renderRTBox,                  SIGNAL(stateChanged(int)),
...
void RenderController::phongShadingCheckChanged(int state)
    ...
    // reset the model's flag
    renderParameters->impulseReflectionOn = (state == Qt::Checked); 
...
void RenderController::depthTestCheckChanged(int state)
    ...
    // reset the model's flag
    renderParameters->shadowsOn = (state == Qt::Checked); 
...
void RenderController::showAxesCheckChanged(int state)
    ...
    // reset the model's flag
    renderParameters->renderRT = (state == Qt::Checked); 
