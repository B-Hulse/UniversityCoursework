...
RenderWindow::RenderWindow
    ...
    shadowsOnBox                = new QCheckBox                 ("Shadows",          this);
    ...
    impulseReflectionBox		        = new QCheckBox         ("Impulse Reflection",       this);
    
    // modelling options
    renderRTBox                 = new QCheckBox                 ("Ray Tracing",         this);  
    ...
    windowLayout->addWidget(renderRTBox,                4,          3,          1,          1           );
    ...
    windowLayout->addWidget(shadowsOnBox,               9,          3,          1,          1           );
    ...
    windowLayout->addWidget(impulseReflectionBox,	    13,         3,          1,          1           );
...
void RenderWindow::ResetInterface()
    ...
    impulseReflectionBox    ->setChecked        (renderParameters   ->  impulseReflectionOn);
    shadowsOnBox            ->setChecked        (renderParameters   ->  shadowsOn);
    renderRTBox             ->setChecked        (renderParameters   ->  renderRT);
